...
class CacheTests(unittest.TestCase):
    ...
    def test_cache_insertion_and_retrieval(self):
        self.cache.set('item2', 'a')
        self.cache.set('item3', 'b')
        self.cache.set('item4', 'c')

        self.assertEqual(self.cache.get('item2'), 'a')
        self.cache.set('item5', 'd')

        self.assertEqual(self.cache.get('item2'), None)
        self.assertEqual(self.cache.get('item4'), 'c')
        self.assertEqual(self.cache.get('item5'), 'd')
        self.assertEqual(self.cache.get('item3'), 'b')
